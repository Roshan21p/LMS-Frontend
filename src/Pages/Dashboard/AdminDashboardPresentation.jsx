  ...
  return (
    <HomeLayout>
      <div className="min-h-[90vh] pt-5 flex flex-col flex-wrap gap-10 text-white">
        ...
        <div className="mx-[10%] sm:w-[80%] self-center flex flex-col items-center justify-center gap-10 mb-10">
              ...
              {myCourses?.map((element, index) => {
                return (
                  <tr key={element?._id}>
                    ...
                    <td className="w-auto overflow-hidden text-ellipsis whitespace-nowrap">
                      <textarea
                        readOnly
